...
//    NSLog(@"TAG: %lu", self.zIndex);
//    if (self.tag == 10) {
//        NSArray *mapOverlays = [NSArray arrayWithArray:_map.overlays];
//        [_map removeOverlays:_map.overlays];
//        [_map addOverlay:self];
//        for (AIRMapPolyline *overlay in mapOverlays) {
//            if (overlay.tag != 10) {
//                [_map insertOverlay:overlay belowOverlay:self];
//            }
//        }
//    }
    if (self.zIndex == 1) {
...
//    NSLog(@"HAHAH : %lu", _map.overlays.count);
//    for (MKAnnotationView* overlay in _map.overlays) {
//        if (overlay.tag == 10) {
