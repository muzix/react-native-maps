...
extern const CLLocationDegrees GMS_AIRMapDefaultSpan;
extern const NSTimeInterval GMS_AIRMapRegionChangeObserveInterval;
extern const CGFloat GMS_AIRMapZoomBoundBuffer;

@interface GMSAIRMap : GMSMapView
